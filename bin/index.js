...
var _htmlToMobiledoc = _interopRequireDefault(
  require('@tryghost/html-to-mobiledoc')
)

var _kgParserPlugins = _interopRequireDefault(
  require('@tryghost/kg-parser-plugins')
)
...
_fs.default.readFile('data/freecodecamp.article.json', 'utf8', function(
  err,
  data
) {
  if (err) throw err
